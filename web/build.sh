...
em++ -O2 -std=c++17 \
  ...
  -s EXPORTED_FUNCTIONS='["_jazzParseChart","_jazzScalesForChord","_jazzReharmonise","_jazzAnalyseVoicing","_jazzIdiomaticVoicings","_jazzRecogniseSubstitution","_jazzIdentifyChord","_jazzReharmPlans","_jazzImportIRealPro","_jazzExportIRealPro","_jazzChartFromPage","_jazzSoloStartTake","_jazzSoloSetBar","_jazzSoloPlayNote","_jazzSoloEndTake","_malloc","_free"]' \
