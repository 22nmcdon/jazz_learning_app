...
em++ -O2 -std=c++17 \
  ...
  -s EXPORTED_FUNCTIONS='["_jazzParseChart","_jazzScalesForChord","_jazzReharmonise","_jazzAnalyseVoicing","_jazzIdiomaticVoicings","_jazzCompingVoicing","_jazzVoicingShape","_jazzVoicingFromShape","_jazzCompStyles","_jazzCompPlan","_jazzCompHit","_jazzCompTake","_jazzWalkingBass","_jazzImprovisedLine","_jazzRecogniseSubstitution","_jazzIdentifyChord","_jazzReharmPlans","_jazzReharmStyles","_jazzVoicedGuideTones","_jazzImportIRealPro","_jazzExportIRealPro","_jazzChartFromPage","_jazzScaleStyles","_jazzSoloStartTake","_jazzSoloSetBar","_jazzSoloPlayNote","_jazzSoloEndTake","_jazzPracticeReading","_jazzTuneProgress","_malloc","_free"]' \
